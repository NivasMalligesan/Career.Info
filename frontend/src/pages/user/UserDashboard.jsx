        ...
        {userStats.profileCompletion < 100 && (
          <div className="mb-6 bg-gradient-to-r from-blue-50 to-cyan-50 border border-blue-200 rounded-xl p-6">
            <div className="flex items-start justify-between gap-4">
              ...
              {/* <Link
                  to="/user/resume-analysis"
                  className="w-full flex items-center gap-3 p-4 bg-gradient-to-r from-indigo-50 to-violet-50
                    hover:from-indigo-100 hover:to-violet-100 rounded-lg transition-all duration-200 group border border-indigo-100"
                >
                  <div className="w-10 h-10 bg-gradient-to-br from-indigo-500 to-violet-600 rounded-lg flex items-center
                    justify-center group-hover:scale-110 transition-transform shadow-md">
